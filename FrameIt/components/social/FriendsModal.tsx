...
export default function FriendsModal({ visible, onClose }: FriendsModalProps) {
  ...
  useEffect(() => {
    if (visible && user?.uid) {
      console.log("FriendsModal opened for user:", user.uid);
      loadFriendsData();
      setSearchTerm("");
      setSearchResults([]);
    }
  ...
  const loadFriendsData = async () => {
    ...
    setLoading(true);
    try {
      console.log("Loading friends data for user:", user.uid);
      ...
      console.log("Friends data loaded:", {
        ...
        sentRequests: sentRequestsData.length,
      });
      ...
      Alert.alert("Error", "Failed to load friends data. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSendFriendRequest = async (toUserId: string) => {
    ...
    try {
      console.log("Sending friend request from", user.uid, "to", toUserId);
      await FirestoreService.sendFriendRequest(user.uid, toUserId);
      console.log("Friend request sent successfully");
      Alert.alert("Success", "Friend request sent!");
      // Remove user from search results and refresh sent requests
    ...
    <View style={styles.requestItem}>
      ...
      <View style={styles.requestActions}>
        <TouchableOpacity
          ...
          onLongPress={() => handleAcceptFriendRequest(item)}
        >
          <Ionicons name="checkmark" size={20} color="#fff" />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.declineButton}
          onLongPress={() => handleDeclineFriendRequest(item.id)}
        >
      ...
      <View style={styles.searchItem}>
        ...
        {isAlreadyFriend ? (
          ...
          <TouchableOpacity
            ...
            onLongPress={() => handleSendFriendRequest(item.userId)}
          >
            ...
            <View style={styles.content}>
              <View style={styles.tabContainer}>
                <TouchableOpacity
                  ...
                  onLongPress={() => setActiveTab("friends")}
                >
                  <Text
                    style={[
                      styles.tabText,
                ...
                <TouchableOpacity
                  ...
                  onLongPress={() => setActiveTab("requests")}
                >
                  <Text
                    style={[
                      styles.tabText,
                ...
                <TouchableOpacity
                  ...
                  onLongPress={() => setActiveTab("search")}
                >
                  <Text
                    style={[
                      styles.tabText,
