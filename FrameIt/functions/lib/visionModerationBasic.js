 ...
 */
exports.moderateImageWithVision = (0, https_1.onCall)({ cors: true }, async (request) => {
    // Verify user is authenticated
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "User must be authenticated to moderate images.");
    }
    const { imageUrl } = request.data;
    if (!imageUrl || typeof imageUrl !== "string") {
        throw new https_1.HttpsError("invalid-argument", "Missing or invalid imageUrl parameter.");
    }
    try {
        ...
        console.log("📊 Vision AI detections:", JSON.stringify(detections, null, 2));
        // Analyze the results
...
//# sourceMappingURL=visionModerationBasic.js.map